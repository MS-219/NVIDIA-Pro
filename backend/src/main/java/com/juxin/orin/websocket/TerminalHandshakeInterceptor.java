...
public class TerminalHandshakeInterceptor implements HandshakeInterceptor {
    ...
    private static final Pattern ADMIN_PATH = Pattern.compile("^/ws/admin/terminal/(ORIN-[A-F0-9]{12,32})$");
    private static final Pattern DEVICE_PATH = Pattern.compile("^/ws/device/(ORIN-[A-F0-9]{12,32})$");
    ...
    public boolean beforeHandshake(
        ...
        if (deviceMatcher.matches()) {
            ...
            String token = request.getHeaders().getFirst("X-Orin-Device-Token");
