...
const templateNotes = {
  ...
  ENV_CHECK: '检查 aarch64、Linux、Python3 和 /opt/juxin-rk3588 节点目录。',
  UPGRADE_AGENT: '在线拉取并安装新版聚芯节点 Agent；系统镜像版本通过独立升级流程管理。',
  INSTALL_DEPS: '安装 curl、wget、python3 和 OpenSSH 客户端，并创建 /opt/juxin-rk3588/runtime。',
  OPEN_TUNNEL: '执行隧道脚本或自定义命令，需要设备已有 SSH 客户端和隧道密钥。',
  CLOSE_TUNNEL: '执行 /opt/juxin-rk3588/tunnel-control.sh stop。',
  RESTART_AGENT: '重启 juxin-rk3588-agent 远程 Agent 服务。',
