  ...
  <div class="overview-page" v-loading="loading">
    <section class="summary-strip">
      ...
      <div class="baseline-tags">
        <span>ARM64</span><span>RK3588</span><span>Linux</span><span>节点在线</span>
      </div>
...
const runtimeBaseline = [
  { label: '节点平台', value: 'Rockchip RK3588', icon: markRaw(Cpu) },
  { label: '系统架构', value: 'ARM64 · 6 Core', icon: markRaw(SetUp) },
  { label: '节点运行时', value: 'RKNN / Linux', icon: markRaw(Coin) },
